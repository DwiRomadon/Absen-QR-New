...
public class Maindosen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maindosen);
        ...
        getSupportActionBar().setTitle("Absen Dosen");
        isLogin();
    ...
    @OnClick(R.id.absen)
    void absen(){
        Intent a = new Intent(Maindosen.this, IntroAbsen.class);
    ...
    void LogOut(){
        ...
        Intent intent = new Intent(Maindosen.this, Login.class);
    ...
    private void cekVersion(final String version) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(status == false){
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(Maindosen.this);
            ...
            public void onErrorResponse(VolleyError error){
                ...
                ImageView image = new ImageView(Maindosen.this);
                ...
                builder.setTitle(Html.fromHtml("<font color='#2980B9'><b>Muat Ulang</b></font>"))
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                Intent a = new Intent(Maindosen.this, MainMahasiswa.class);
                                startActivity(a);
                                finish();
                            }
                        }).setView(image)
